...
import com.minjiki2.section9.model.Customer;
import com.minjiki2.section9.repository.CustomerRepository;
...
public class MinjiBankUsernamePasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        // 1. DB로부터 유저 정보 불러오기
        List<Customer> customers = customerRepository.findByEmail(username).stream().toList();
