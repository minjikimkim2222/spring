...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문취소 시 상태는 CANCEL이다.", getOrder.getStatus(), OrderStatus.CANCEL);
        assertEquals("주문취소된 상품은 그만큼 재고가 증가해야 한다", 10, book.getStockQuantity());
    ...
    private Item createItem() {
        ...
        book.setName("실전 JPA");
        book.setPrice(10000);
        book.setStockQuantity(10); // 재고 10권
        em.persist(book);
        return book;
    }
}